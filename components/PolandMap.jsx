...
const PolandMap = () => {
  ...
  return (
    <div className="container w-full mx-auto">
      <h1 className='my-4 w-full mx-auto text-3xl font-bold text-center text-main-color'>Sprawdź gdzie jesteśmy</h1>
      ...
      <div className={`flex h-48 w-full p-4 rounded-lg items-center ${hoveredElement ? 'bg-main-bg-color bg-opacity-50' :' bg-transparent' } `}>
        {hoveredElement && (
          <div className='flex flex-col gap-1'>
            {/* Address */}
            <div className='flex items-center text-base font-bold text-white'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="#e5097f" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-3">
            ...
            <div className='flex items-center text-base font-bold text-white'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="transparent" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-3 text-transparent">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
